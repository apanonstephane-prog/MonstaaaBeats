...
-- cover_url : à remplacer après upload des covers dans Storage (bucket beats-covers)
-- Format URL : https://<project>.supabase.co/storage/v1/object/public/beats-covers/<nom>.jpg
-- ============================================================

INSERT INTO public.beats
  (name, genre, bpm, musical_key, duration_seconds, duration_label, beat_type, price_eur, tags, vibe, audio_url, cover_url, is_featured, sort_order)
VALUES
  -- FREE BEATS
